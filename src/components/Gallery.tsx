...
export default function Gallery() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-1/2 left-1/2 w-[800px] h-[800px] rounded-full animate-disco-rotate opacity-[0.04]"
        style={{
          background:
            "conic-gradient(from 0deg, transparent 0deg, white 2deg, transparent 4deg, transparent 30deg, white 32deg, transparent 34deg, transparent 60deg, white 62deg, transparent 64deg, transparent 90deg, white 92deg, transparent 94deg, transparent 120deg, white 122deg, transparent 124deg, transparent 150deg, white 152deg, transparent 154deg, transparent 180deg, white 182deg, transparent 184deg, transparent 210deg, white 212deg, transparent 214deg, transparent 240deg, white 242deg, transparent 244deg, transparent 270deg, white 272deg, transparent 274deg, transparent 300deg, white 302deg, transparent 304deg, transparent 330deg, white 332deg, transparent 334deg)",
        }}
      />
